...
<div class="ui-grid-b">
	<div class="ui-block-a">
            <a href="<?= $controller->url_for("activities") ?>" data-role="button" data-icon="home" data-iconpos="top">Activity Feed</a>
        </div>
	<div class="ui-block-b">
            <a href="<?= $controller->url_for("courses") ?>" data-role="button" data-icon="gear" data-iconpos="top">Courses</a>
        </div>
	<div class="ui-block-c">
            <a href="index.html" data-role="button" data-icon="star" data-iconpos="top">Option 3</a>
        </div>
	<div class="ui-block-a">
